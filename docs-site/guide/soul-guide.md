...
SOUL.md 定义 Agent 的"先天性格"，[Agent 持久记忆](/features/agent-memory)存储"后天经验"。两者配合：
...
在 [多 Agent 群聊](/features/multi-agent-chat) 的群组中，Agent 可能会自由 @mention 其他 Agent。你可以用 SOUL.md 控制这种行为：
...
在群组中测试 Agent 之间的互动（与 [协作流](/features/collaboration-flow) 中的协作链可对照实验）：
...
虾饺内置了 5 个 SOUL.md 模板在 `data/_soul-templates/` 目录中，更多模板见 [模板库](/guide/soul-templates)。你可以：
...
- [模板库](/guide/soul-templates) — 20 个可复制的 Agent 人格模板
- [实战案例](/guide/recipes) — 完整团队配置与协作链方案
...
- [术语表](/guide/glossary) — SOUL.md 相关术语
