...
- [协作流](/zh/features/collaboration-flow) — 了解协作链和可视化面板的完整机制
- [Tool Calling](/zh/features/tool-calling) — Agent 不只聊天，还能搜索、记忆、调用其他 Agent
- [Agent 持久记忆](/zh/features/agent-memory) — Agent 如何记住你的偏好
- [SOUL.md 写作指南](/zh/guide/soul-guide) — 如何写出高质量的 Agent 人格设定
- [SOUL.md 模板库](/zh/guide/soul-templates) — 20 个可直接复制的 Agent 人格模板
- [平台对比](/zh/guide/comparison) — 虾饺 vs Dify vs Coze vs FastGPT
- [实战案例](/zh/guide/recipes) — 12 个可直接照搬的 Agent 团队配置方案
