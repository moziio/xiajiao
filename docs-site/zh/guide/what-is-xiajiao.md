...
| 能力 | 说明 | 详情 |
|------|------|------|
| 🤖 多 Agent 群聊 | 群组 + @mention 路由 + Agent 间对话 | [详情](/zh/features/multi-agent-chat) |
| 🔧 Tool Calling | 7 个内置工具（搜索、记忆、RAG、跨 Agent 调用等） | [详情](/zh/features/tool-calling) |
| 🧠 持久记忆 | 三分类记忆（语义 / 情景 / 程序性），embedding 去重 | [详情](/zh/features/agent-memory) |
| 📚 RAG 知识库 | BM25 + 向量混合检索 + RRF + LLM 重排序 | [详情](/zh/features/rag) |
| 🔗 协作流 | 协作链 + 可视化面板 + 人工干预 | [详情](/zh/features/collaboration-flow) |
| 🔌 多模型 | OpenAI / Claude / 通义 / DeepSeek / Ollama 等 | [详情](/zh/guide/model-config) |
...
详细对比见 [平台对比](/zh/guide/comparison)。
...
| 你想... | 看这里 |
|---------|--------|
| 立刻试试 | [快速开始](/zh/guide/quick-start) — 3 步跑起来 |
| 配置模型 | [模型配置大全](/zh/guide/model-config) — 8 个 Provider 详细教程 |
| 学 Agent 设计 | [SOUL.md 写作指南](/zh/guide/soul-guide) — 写出好的 Agent 人格 |
| 复制 Agent 模板 | [SOUL.md 模板库](/zh/guide/soul-templates) — 20 个模板 |
| 照搬方案 | [实战案例](/zh/guide/recipes) — 12 个 Agent 团队配置 |
| 了解技术 | [架构设计](/zh/guide/architecture) — 代码结构和数据流 |
| 对比平台 | [平台对比](/zh/guide/comparison) — vs Dify/Coze/FastGPT |
| 确认安全 | [安全与隐私](/zh/guide/security) — 数据主权详解 |
