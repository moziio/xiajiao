...
- [快速开始](/zh/guide/quick-start) — 安装虾饺
- [SOUL.md 写作指南](/zh/guide/soul-guide) — 写好 Agent 人格设定
- [SOUL.md 模板库](/zh/guide/soul-templates) — 20 现成模板
- [模型配置](/zh/guide/model-config) — 8 个 Provider 配置教程
- [平台对比](/zh/guide/comparison) — 详细功能对比
- [实战案例](/zh/guide/recipes) — 12 个 Agent 团队配置方案
