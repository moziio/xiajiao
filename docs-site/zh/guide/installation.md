...
详见 [Docker 部署](/zh/deployment/docker)。
...
- [快速开始](/zh/guide/quick-start) — 配置模型，开始聊天
- [模型配置](/zh/guide/model-config) — 详细的 LLM Provider 配置教程
- [本地部署](/zh/deployment/local) — 后台运行、开机自启、数据备份
- [Docker 部署](/zh/deployment/docker) — 容器化部署
- [多 Agent 群聊](/zh/features/multi-agent-chat) — 创建群组，体验协作
- [故障排查](/zh/guide/troubleshooting) — 更多问题解决方案
