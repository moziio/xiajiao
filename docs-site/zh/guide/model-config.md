...
虾饺支持所有 OpenAI 兼容 API 的模型。本页提供每个主流 Provider 的详细配置方法。若尚未本地跑通服务，请先 [快速开始](/zh/guide/quick-start)。配好模型后若要精简人格与省 token，可配合 [SOUL.md 编写指南](/zh/guide/soul-guide) 调整各 Agent 的 `SOUL.md`。
...
3. **[SOUL.md](/zh/guide/soul-guide) 越精准，prompt token 越少**，每次调用省几百 token
...
1. **精简 [SOUL.md](/zh/guide/soul-guide)**：去掉冗余描述，每少 100 字 = 每次调用省 ~100 tokens
...
- [快速开始](/zh/guide/quick-start) — 从安装到第一次对话
- [SOUL.md 编写指南](/zh/guide/soul-guide) — 控制人格与输出以节省 token
- [多 Agent 群聊](/zh/features/multi-agent-chat) — 体验多 Agent 协作
- [性能调优](/zh/guide/performance) — 优化 LLM 调用性能
- [术语表](/zh/guide/glossary) — 不懂的术语看这里
- [常见问题](/zh/guide/faq) — 其他常见问题
