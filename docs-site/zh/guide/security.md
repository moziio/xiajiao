...
| LLM 配置 | `data/xiajiao.db` (settings 表) | SQLite |
...
4. **验证数据存储**（`sqlite3 data/xiajiao.db .dump`）
...
- [云服务器部署](/zh/deployment/cloud) — 包含 Nginx + HTTPS + 防火墙完整配置
- [Docker 部署](/zh/deployment/docker) — 容器隔离
- [API 与协议参考](/zh/guide/api-reference) — 了解所有 API 端点
- [故障排查](/zh/guide/troubleshooting) — 安全相关故障
- [常见问题](/zh/guide/faq) — 安全相关 FAQ
- [架构设计](/zh/guide/architecture) — 了解代码结构做安全审计
